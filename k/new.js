...
const apiKey = "AIzaSyCYFZHp7Dvf0AeY3d6ygfpD5Jw5s85bPL0"; 
...
async function sendQuery() {
  ...
  try {
    ...
    box.textContent = cleanedResponseText;

    // Auto-speak cleaned response always
    if (cleanedResponseText && cleanedResponseText !== "No response text found.") {
      setTimeout(() => {
        speakText(cleanedResponseText);
      }, 500);
    }
